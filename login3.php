...
if(isset($_POST['Done']))
{
    ...
    $check = $mysqli->query("SELECT * FROM investor WHERE Email = '$mail'");
            ...
            <div class="form login">
                ...
                <form action="" method="POST">
                    ...
                    <div class="checkbox-text">
                        ...
                        <a href="Iforgot.php" class="text">Forgot password?</a>
                    </div>
